...
import com.github.vindell.calibre.invoker.request.Web2diskInvocationRequest;
...
public class Web2diskCommandLineBuilder extends AbstractCommandLineBuilder {
	...
	protected void setDelay(Web2diskInvocationRequest request, Commandline cli) {
		int delay = request.getDelay();
		cli.createArg().setValue("--delay");
		cli.createArg().setValue(String.valueOf(delay));
	}
 
	protected void setDontDownloadStylesheets(Web2diskInvocationRequest request, Commandline cli) {
		if(request.isDontDownloadStylesheets()) {
			cli.createArg().setValue("--dont-download-stylesheets");
		}
	}
	
	protected void setEncoding(Web2diskInvocationRequest request, Commandline cli) {
	...
	protected void setFilterRegexp(Web2diskInvocationRequest request, Commandline cli) {
	...
	protected void setMatchRegexp(Web2diskInvocationRequest request, Commandline cli) {
	...
	protected void setMaxFiles(Web2diskInvocationRequest request, Commandline cli) {
	...
	protected void setMaxRecursions(Web2diskInvocationRequest request, Commandline cli) {
	...
	protected void setTimeout(Web2diskInvocationRequest request, Commandline cli) {
